...
def gen_vis(tree: ProtoTree, folder_name: str, args: argparse.Namespace, classes:tuple, save_dir:str):
    destination_folder=os.path.join(save_dir,folder_name)
    # upsample_dir = os.path.join(destination_folder, args.dir_for_saving_images)
    upsample_dir = os.path.join(save_dir, args.dir_for_saving_images, folder_name)
