...
# Prune tree
def prune(tree: ProtoTree, pruning_threshold_leaves: float) -> list:
    print("Pruning...")
    print("Before pruning: %s branches and %s leaves"%(tree.num_branches,tree.num_leaves))
    ...
    print("After pruning: %s branches and %s leaves"%(tree.num_branches,tree.num_leaves))
    print("Fraction of prototypes pruned: %s"%((num_prototypes_before-tree.num_branches)/float(num_prototypes_before))+'\n')
