...
if __name__ == '__main__':
    ...
    vgg11_f = vgg11_features()
    pytorch_total_params = sum(p.numel() for p in vgg11_f.parameters() if p.requires_grad)
    print(f"\033[0;30;43m{pytorch_total_params}\033[0m")
    print(vgg11_f)

    vgg11_bn_f = vgg11_bn_features()
    pytorch_total_params = sum(p.numel() for p in vgg11_bn_f.parameters() if p.requires_grad)
    print(f"\033[0;30;43m{pytorch_total_params}\033[0m")
    print(vgg11_bn_f)

    vgg13_f = vgg13_features()
    pytorch_total_params = sum(p.numel() for p in vgg13_f.parameters() if p.requires_grad)
    print(f"\033[0;30;43m{pytorch_total_params}\033[0m")
    print(vgg13_f)

    vgg13_bn_f = vgg13_bn_features()
    pytorch_total_params = sum(p.numel() for p in vgg13_bn_f.parameters() if p.requires_grad)
    print(f"\033[0;30;43m{pytorch_total_params}\033[0m")
    print(vgg13_bn_f)

    vgg16_f = vgg16_features()
    pytorch_total_params = sum(p.numel() for p in vgg16_f.parameters() if p.requires_grad)
    print(f"\033[0;30;43m{pytorch_total_params}\033[0m")
    print(vgg16_f)

    vgg16_bn_f = vgg16_bn_features()
    pytorch_total_params = sum(p.numel() for p in vgg16_bn_f.parameters() if p.requires_grad)
    print(f"\033[0;30;43m{pytorch_total_params}\033[0m")
    print(vgg16_bn_f)

    vgg19_f = vgg19_features()
    pytorch_total_params = sum(p.numel() for p in vgg19_f.parameters() if p.requires_grad)
    print(f"\033[0;30;43m{pytorch_total_params}\033[0m")
    print(vgg19_f)

    vgg19_bn_f = vgg19_bn_features()
    pytorch_total_params = sum(p.numel() for p in vgg19_bn_f.parameters() if p.requires_grad)
    print(f"\033[0;30;43m{pytorch_total_params}\033[0m")
    print(vgg19_bn_f)
