# https://github.com/dvlab-research/MiSLAS/blob/0fc381e333d8a11170851b7af2058c59840969e0/models/resnet_cifar.py#L1
...
def resnet32_fe(pretrained=False, **kwargs):
...
def parameter(net_name):
    feature = globals()[net_name]()
    print(net_name)
    pytorch_total_params = sum(p.numel() for p in feature.parameters() if p.requires_grad)
